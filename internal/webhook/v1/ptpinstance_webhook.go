...
func SetupPtpInstanceWebhookWithManager(mgr ctrl.Manager) error {
...
func (d *PtpInstanceCustomDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	ptpInstance, ok := obj.(*starlingxv1.PtpInstance)
	if !ok {
...
func validatePtpInstance(r *starlingxv1.PtpInstance) error {
	// Multiple parameters are allowed for these unicast_master_table section's parameters
	allowedMultipleUMTSet := map[string]bool{
		"UDPv4": true,
		"UDPv6": true,
		"L2":    true,
	}

	for section, parameters := range r.Spec.InstanceParameters {
...
func (v *PtpInstanceCustomValidator) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	return nil, validatePtpInstance(ptpInstance)
}
...
func (d *PtpInstanceCustomValidator) ValidateUpdate(cxt context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	ptpInstance, ok := newObj.(*starlingxv1.PtpInstance)
	if !ok {
