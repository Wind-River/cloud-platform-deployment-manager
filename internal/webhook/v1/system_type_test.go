...
var _ = Describe("System controller", func() {
	...
	Describe("DeepEqual function", func() {
		...
		Context("ServiceParameters", func() {
			It("Should match unordered arrays", func() {
				in := starlingxv1.SystemSpec{
					ServiceParameters: starlingxv1.ServiceParameterList{
						{
							Service:    "sysinv",
							Section:    "global",
							ParamName:  "param1",
		...
		Context("When both type and secret are same but signature is different in 2 entities", func() {
			It("Returns true", func() {
				other := &starlingxv1.CertificateInfo{
					Type:   "ssl",
					Secret: "secret",
				}
				in := &starlingxv1.CertificateInfo{
					Signature: "",
					Type:      "ssl",
					Secret:    "secret",
				}
