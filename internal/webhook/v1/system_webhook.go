...
func (d *SystemCustomDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	system, ok := obj.(*starlingxv1.System)
	if !ok {
...
func validateBackendAttributes(backend starlingxv1.StorageBackend) error {
...
func validateStorageBackends(obj *starlingxv1.System) error {
...
func validateStorage(obj *starlingxv1.System) error {
...
func validateCertificates(obj *starlingxv1.System) error {
	for _, c := range obj.Spec.Certificates {
		...
		if c.Type == starlingxv1.OpenstackCACertificate || c.Type == starlingxv1.OpenLDAPCertificate ||
			c.Type == starlingxv1.DockerCertificate || c.Type == starlingxv1.PlatformCertificate {
			continue
		}
...
func validatingSystem(r *starlingxv1.System) error {
...
func (v *SystemCustomValidator) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	return nil, validatingSystem(system)
}
...
func (v *SystemCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	system, ok := newObj.(*starlingxv1.System)
	if !ok {
