...
func (h *PlatformNetworkCreateUpdateHandler) validateAddressFamilies(obj *starlingxv1.PlatformNetwork) (bool, string, error) {
...
func (h *PlatformNetworkCreateUpdateHandler) validatingPlatformNetworkFn(ctx context.Context, obj *starlingxv1.PlatformNetwork) (bool, string, error) {
