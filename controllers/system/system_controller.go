...
// RefreshServiceParameters updates the service parameters list in SystemInfo
func (r *SystemReconciler) RefreshServiceParameters(client *gophercloud.ServiceClient, instance *starlingxv1.System, info *v1info.SystemInfo) error {
...
func (r *SystemReconciler) ReconcileServiceParameters(client *gophercloud.ServiceClient, instance *starlingxv1.System, spec *starlingxv1.SystemSpec, info *v1info.SystemInfo) error {
	...
	if updated {
		error := r.RefreshServiceParameters(client, instance, info)
		if error != nil {
			return error
		}
	}
	...
	// update the system object with the list of service params
	if updated {
		err := r.RefreshServiceParameters(client, instance, info)
		if err != nil {
			return err
		}
	}
