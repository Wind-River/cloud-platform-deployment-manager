...
func (r *PtpInterfaceReconciler) UpdateScopeConfig(instance *starlingxv1.PtpInterface) (err error) {
...
func (r *PtpInterfaceReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	logPtpInterface.V(2).Info("before UpdateScopeConfig", "instance", instance)
	err = r.UpdateScopeConfig(instance)
	if err != nil {
		logPtpInterface.Error(err, "unable to update scope")
		return reconcile.Result{}, err
	}
	logPtpInterface.V(2).Info("after UpdateScopeConfig", "instance", instance)
