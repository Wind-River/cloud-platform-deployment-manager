...
var _ = BeforeSuite(func() {
	...
	err = (&HostProfile{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())

	err = (&Host{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())
	...
	err = (&PtpInterface{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())

	err = (&System{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())
