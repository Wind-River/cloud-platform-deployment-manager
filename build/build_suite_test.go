...
var _ = Describe("Test Build utilities:", func() {
	...
	Describe("Test isInterfaceInUse", func() {
		It("when bonds Members has the ifname interface", func() {
			ifname := "ifname"
	...
	Describe("Test isInterfaceInUse", func() {
		It("when VLAN lower defines the ifname interface", func() {
			ifname := "ifname"
			info := &starlingxv1.InterfaceInfo{}
	...
	Describe("Test isInterfaceInUse", func() {
		It("when VF lower defines the ifname interface", func() {
			ifname := "ifname"
			info := &starlingxv1.InterfaceInfo{}
			info.VF = make(starlingxv1.VFList, 1)
			bonds := make(starlingxv1.BondList, 1)
	...
	Describe("Test isInterfaceInUse", func() {
		It("when interface is not in use", func() {
			ifname := "ifname"
			info := &starlingxv1.InterfaceInfo{}
			info.VF = make(starlingxv1.VFList, 1)
			bonds := make(starlingxv1.BondList, 1)
